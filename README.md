...
В данном хранилище расположен триангулятор - имплантат, позволяющий быстро засечь последнее расположение отмеченных пользователей при проявлении ими активности.
Для имплантата указывается список пользователей, за которыми необходимо проводить наблюдение, и в случае проявление кем либо из них активности в комментариях, производится соответствующее оповещение.
